...
describe("Modern Grep Content Tool", () => {
  ...
  it("should search content with structured parameters", async () => {
    ...
    const testContent =
      "This is a test file with some specific content to search for.\nAnother line with more content.";
  ...
  it("should handle invalid search paths", async () => {
    ...
    expect(result).toContain(
      "attempts to escape the working directory sandbox"
    );
  });
  ...
  it("should handle regex patterns", async () => {
    ...
    const testContent =
      "const test123 = 456; const abc = 789; const test456 = 123;";
    fs.writeFileSync(testFile, testContent);
  ...
  it("should handle context lines correctly with streaming search", async () => {
    ...
    const lines = ["Line 1", "Line 2", "Target Match", "Line 4", "Line 5"];
