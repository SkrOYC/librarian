...
describe("CLI Integration", () => {
  ...
  describe("Explore Command", () => {
    ...
    it("should prevent using both tech and group flags", async () => {
      const result = await helper.runCommand(
        ["explore", "test query", "--tech", "react", "--group", "default"],
        mockConfig
      );
  ...
  describe("Error Handling", () => {
    it("should handle invalid technology names", async () => {
      const result = await helper.runCommand(
        ["explore", "test query", "--tech", "nonexistent-tech"],
        mockConfig
      );
    ...
    it("should handle invalid group names", async () => {
      const result = await helper.runCommand(
        ["explore", "test query", "--group", "nonexistent-group"],
        mockConfig
      );
    ...
    it("should handle malformed repository URLs", async () => {
      ...
      const result = await helper.runCommand(
        ["explore", "test query", "--tech", "bad-repo"],
        badConfig
      );
  ...
  describe("Output Formatting", () => {
    ...
    it("should handle long queries without line breaking issues", async () => {
      const longQuery =
        "This is a very long query that contains multiple words and should be handled properly by the CLI without causing line breaking or formatting issues in the output.";
  ...
  describe("Security Validation", () => {
    it("should prevent path traversal attacks", async () => {
      const result = await helper.runCommand(
        ["explore", "test query", "--tech", "../../../etc/passwd"],
        mockConfig
      );
    ...
    it("should sanitize repository URLs", async () => {
      ...
      const result = await helper.runCommand(
        ["explore", "test query", "--tech", "malicious"],
        maliciousConfig
      );
